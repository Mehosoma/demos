    ...
    function e(t) {
        ...
        function e(t, e, i) {
            ...
            if (!n || !n.of) return d.apply(this, arguments);n = t.extend({}, n);var u,
                ...
                x = {};return _ = s(v), v[0].preventDefault && (n.at = "left top"), p = _.width, f = _.height, g = _.offset, m = t.extend({}, g), t.each(["my", "at"], function () {
                var t,
                    e,
                    i = (n[this] || "").split(" ");1 === i.length && (i = r.test(i[0]) ? i.concat(["center"]) : h.test(i[0]) ? ["center"].concat(i) : ["center", "center"]), i[0] = r.test(i[0]) ? i[0] : "center", i[1] = h.test(i[1]) ? i[1] : "center", t = l.exec(i[0]), e = l.exec(i[1]), x[this] = [t ? t[0] : 0, e ? e[0] : 0], n[this] = [c.exec(i[0])[0], c.exec(i[1])[0]];
                ...
                var s,
                    ...
                    D = t.extend({}, m),
                    P = e(x.my, h.outerWidth(), h.outerHeight());"right" === n.my[0] ? D.left -= l : "center" === n.my[0] && (D.left -= l / 2), "bottom" === n.my[1] ? D.top -= c : "center" === n.my[1] && (D.top -= c / 2), D.left += P[0], D.top += P[1], s = { marginLeft: d, marginTop: _ }, t.each(["left", "top"], function (e, i) {
                    t.ui.position[w[e]] && t.ui.position[w[e]][i](D, { targetWidth: p, targetHeight: f, elemWidth: l, elemHeight: c, collisionPosition: s, collisionWidth: k, collisionHeight: C, offset: [u[0] + P[0], u[1] + P[1]], my: n.my, at: n.at, within: b, elem: h });
        ...
        return t.ui.controlgroup || t.error("Controlgroup widget missing"), "option" === arguments[0] && "items" === arguments[1] && arguments[2] ? this.controlgroup.apply(this, [arguments[0], "items.button", arguments[2]]) : "option" === arguments[0] && "items" === arguments[1] ? this.controlgroup.apply(this, [arguments[0], "items.button"]) : ("object" == _typeof(arguments[0]) && arguments[0].items && (arguments[0].items = { button: arguments[0].items }), this.controlgroup.apply(this, arguments));
            ...
            if (null == e || null == i) throw "Invalid arguments";if (i = "object" == (typeof i === "undefined" ? "undefined" : _typeof(i)) ? "" + i : i + "", "" === i) return null;var n,
                ...
                if (b) "'" !== e.charAt(n) || y("'") ? k() : b = !1;else switch (e.charAt(n)) {case "d":
                        _ = w("d");break;case "D":
                        x("D", u, d);break;case "o":
                        v = w("o");break;case "m":
                        m = w("m");break;case "M":
                        m = x("M", p, f);break;case "y":
                        g = w("y");break;case "@":
            ...
            var e,
                ...
                J = t.drawMonth - V,
                te = t.drawYear;if (0 > J && (J += 12, te--), Z) for (e = this._daylightSavingAdjust(new Date(Z.getFullYear(), Z.getMonth() - U[0] * U[1] + 1, Z.getDate())), e = Q && Q > e ? Q : e; this._daylightSavingAdjust(new Date(te, J, 1)) > e;) {
                J--, 0 > J && (J = 11, te--);
            }for (t.drawMonth = J, t.drawYear = te, i = this._get(t, "prevText"), i = K ? this.formatDate(i, this._daylightSavingAdjust(new Date(te, J - X, 1)), this._getFormatConfig(t)) : i, s = this._canAdjustMonth(t, -1, te, J) ? "<a class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (Y ? "e" : "w") + "'>" + i + "</span></a>" : q ? "" : "<a class='ui-datepicker-prev ui-corner-all ui-state-disabled' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (Y ? "e" : "w") + "'>" + i + "</span></a>", n = this._get(t, "nextText"), n = K ? this.formatDate(n, this._daylightSavingAdjust(new Date(te, J + X, 1)), this._getFormatConfig(t)) : n, o = this._canAdjustMonth(t, 1, te, J) ? "<a class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click' title='" + n + "'><span class='ui-icon ui-icon-circle-triangle-" + (Y ? "w" : "e") + "'>" + n + "</span></a>" : q ? "" : "<a class='ui-datepicker-next ui-corner-all ui-state-disabled' title='" + n + "'><span class='ui-icon ui-icon-circle-triangle-" + (Y ? "w" : "e") + "'>" + n + "</span></a>", a = this._get(t, "currentText"), r = this._get(t, "gotoCurrent") && t.currentDay ? G : B, a = K ? this.formatDate(a, r, this._getFormatConfig(t)) : a, h = t.inline ? "" : "<button type='button' class='ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all' data-handler='hide' data-event='click'>" + this._get(t, "closeText") + "</button>", l = j ? "<div class='ui-datepicker-buttonpane ui-widget-content'>" + (Y ? h : "") + (this._isInRange(t, r) ? "<button type='button' class='ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler='today' data-event='click'>" + a + "</button>" : "") + (Y ? "" : h) + "</div>" : "", c = parseInt(this._get(t, "firstDay"), 10), c = isNaN(c) ? 0 : c, u = this._get(t, "showWeek"), d = this._get(t, "dayNames"), p = this._get(t, "dayNamesMin"), f = this._get(t, "monthNames"), g = this._get(t, "monthNamesShort"), m = this._get(t, "beforeShowDay"), _ = this._get(t, "showOtherMonths"), v = this._get(t, "selectOtherMonths"), b = this._getDefaultDate(t), y = "", x = 0; U[0] > x; x++) {
                for (k = "", this.maxRows = 4, C = 0; U[1] > C; C++) {
                    if (D = this._daylightSavingAdjust(new Date(te, J, t.selectedDay)), P = " ui-corner-all", I = "", $) {
                        if (I += "<div class='ui-datepicker-group", U[1] > 1) switch (C) {case 0:
                                I += " ui-datepicker-group-first", P = " ui-corner-" + (Y ? "right" : "left");
                                break;case U[1] - 1:
                                I += " ui-datepicker-group-last", P = " ui-corner-" + (Y ? "left" : "right");break;default:
                                I += " ui-datepicker-group-middle", P = "";}I += "'>";
                    }for (I += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + P + "'>" + (/all|left/.test(P) && 0 === x ? Y ? o : s : "") + (/all|right/.test(P) && 0 === x ? Y ? s : o : "") + this._generateMonthYearHeader(t, J, te, Q, Z, x > 0 || C > 0, f, g) + "</div><table class='ui-datepicker-calendar'><thead>" + "<tr>", T = u ? "<th class='ui-datepicker-week-col'>" + this._get(t, "weekHeader") + "</th>" : "", w = 0; 7 > w; w++) {
                        S = (w + c) % 7, T += "<th scope='col'" + ((w + c + 6) % 7 >= 5 ? " class='ui-datepicker-week-end'" : "") + ">" + "<span title='" + d[S] + "'>" + p[S] + "</span></th>";
                    }for (I += T + "</tr></thead><tbody>", z = this._getDaysInMonth(te, J), te === t.selectedYear && J === t.selectedMonth && (t.selectedDay = Math.min(t.selectedDay, z)), M = (this._getFirstDayOfMonth(te, J) - c + 7) % 7, H = Math.ceil((M + z) / 7), O = $ ? this.maxRows > H ? this.maxRows : H : H, this.maxRows = O, W = this._daylightSavingAdjust(new Date(te, J, 1 - M)), E = 0; O > E; E++) {
                        for (I += "<tr>", A = u ? "<td class='ui-datepicker-week-col'>" + this._get(t, "calculateWeek")(W) + "</td>" : "", w = 0; 7 > w; w++) {
                            N = m ? m.apply(t.input ? t.input[0] : null, [W]) : [!0, ""], F = W.getMonth() !== J, R = F && !v || !N[0] || Q && Q > W || Z && W > Z, A += "<td class='" + ((w + c + 6) % 7 >= 5 ? " ui-datepicker-week-end" : "") + (F ? " ui-datepicker-other-month" : "") + (W.getTime() === D.getTime() && J === t.selectedMonth && t._keyEvent || b.getTime() === W.getTime() && b.getTime() === D.getTime() ? " " + this._dayOverClass : "") + (R ? " " + this._unselectableClass + " ui-state-disabled" : "") + (F && !_ ? "" : " " + N[1] + (W.getTime() === G.getTime() ? " " + this._currentClass : "") + (W.getTime() === B.getTime() ? " ui-datepicker-today" : "")) + "'" + (F && !_ || !N[2] ? "" : " title='" + N[2].replace(/'/g, "&#39;") + "'") + (R ? "" : " data-handler='selectDay' data-event='click' data-month='" + W.getMonth() + "' data-year='" + W.getFullYear() + "'") + ">" + (F && !_ ? "&#xa0;" : R ? "<span class='ui-state-default'>" + W.getDate() + "</span>" : "<a class='ui-state-default" + (W.getTime() === B.getTime() ? " ui-state-highlight" : "") + (W.getTime() === G.getTime() ? " ui-state-active" : "") + (F ? " ui-priority-secondary" : "") + "' href='#'>" + W.getDate() + "</a>") + "</td>", W.setDate(W.getDate() + 1), W = this._daylightSavingAdjust(W);
                        }I += A + "</tr>";
                    }J++, J > 11 && (J = 0, te++), I += "</tbody></table>" + ($ ? "</div>" + (U[0] > 0 && C === U[1] - 1 ? "<div class='ui-datepicker-row-break'></div>" : "") : ""), k += I;
                }y += k;
...
$(document).ready(function () {
    ...
    $('.header-nav').css('margin-right', -sw + 'px');

    // отмена действия в меню на клик
    $('.toggle-click').on('click', function (e) {
        e.preventDefault();
        var target = $(this).parent()[0].children[1];
        $(target).click();
    });

    $('header nav > ul > li').hover(function () {
        if ($(window).width() > 768 - sw) {
            if ($(this).children('.info-block-description-wrapper').length) {
                $(this).children('.info-block-description-wrapper').addClass('show');
                $('.cover-nav').addClass('show');
            }
        }
    }, function () {
        $('.cover-nav').removeClass('show');
        $(this).children('.info-block-description-wrapper').removeClass('show');
        setTimeout(function () {}, 400);
    });
    $('footer nav > ul > li').hover(function () {
        if ($(window).width() > 768 - sw) {
            var fH = $('footer').height();
            var posT = $('footer .wrapper-nav').position().top;
            // console.log(fH);

            $(this).children('.info-block-description-wrapper').css({ 'height': fH - posT - 20 + 'px' });
            if ($(this).children('.info-block-description-wrapper').length) {
                $(this).children('.info-block-description-wrapper').addClass('show');
                $('.cover-nav').addClass('show');
            }
    ...
    $('header .search').click(function () {
        ...
        $('body > header').addClass('modal-close');
        setTimeout(function () {
            if ($('.expander .expander-inner').hasClass('active')) {
                expanderCloseAnim();
            }
            $('.expander .expander-inner').removeClass('active');
        }, 400);
        $('.search-popup').fadeIn(400);
        $('header .logo').addClass('zindex');
        scrollCover();
    });
    $('.search-popup .close').click(function () {
        $('.search-popup').fadeOut(400);
        setTimeout(function () {
            $('header .logo').removeClass('zindex');
        }, 400);
        scrollBody();
    });
    //open search end
    //info-blocks expander begin
    $('.info-block-description li .expand').click(function () {
        var cur = $('.info-block-description li .expand').index(this);
        $('.submenu').eq(cur).stop().slideToggle(300, function () {});

        if ($(this).hasClass('hide')) {
            $('.info-block-description li .expand').eq(cur).removeClass('hide');
        } else {
            $('.info-block-description li .expand').eq(cur).addClass('hide');
        }
    });
    $('.info-block-description li .expand').addClass('hide');
    $('.submenu').hide();
    //info-blocks expander end
    //modals begin
    function scrollCover() {
        $('.cover').fadeIn(200).css({
            'overflow-y': 'scroll',
            'overflow-x': 'visible'
        });
    ...
    function expanderCloseAnim() {
        $('.expander .expander-inner div:nth-child(1)').css({
            'left': '0px',
            'width': '36px',
        ...
        $('.expander .expander-inner div:nth-child(2)').css({
            'left': '0px',
            'width': '36px',
            'transform': 'rotate(45deg)'
        }).stop(true).animate({
        ...
        $('.expander .expander-inner div:nth-child(3)').css({
            'left': '0px',
            'width': '36px',
            'transform': 'rotate(-45deg)'
        }).stop(true).animate({
    ...
    $('.expander .expander-inner').click(function () {
        if ($('.expander .expander-inner').hasClass('active')) {
            scrollBody();
            $('.expander .expander-inner').removeClass('active');
            $('.cover, .cover > .main-popup').stop().fadeOut(400);
            setTimeout(function () {
                $('body > header').removeClass('modal-open');
                $('body > header').addClass('modal-close');
            });
            ...
            $('.expander .expander-inner').addClass('active');
            scrollCover();
            $('.cover, .cover > .main-popup').stop().fadeIn(400);
            $('body > header').removeClass('modal-close');
            $('body > header').addClass('modal-open');
            var expDiv = $('.expander .expander-inner div');
            $('.expander .expander-inner div:nth-child(1)').stop(true).animate({
                'top': '50%',
                'margin-top': '-1px'
            }).animate({
                'transform': 'rotate(45deg)',
            ...
            $('.expander .expander-inner div:nth-child(2)').stop(true).animate({
                'top': '50%',
                'margin-top': '-1px'
            }).animate({
                'transform': 'rotate(45deg)',
            ...
            $('.expander .expander-inner div:nth-child(3)').stop(true).animate({
                'bottom': '50%',
                'margin-bottom': '-1px'
            }).animate({
                'transform': 'rotate(-45deg)',
    ...
    //modals end
    function playVideoCarousel() {
        $('.main-articles .owl-item.active article video')[0].play();
    }

    // список урлов где запускать функцию видео
    if (window.location.pathname === '/' || window.location.pathname === '/shop') {
        setTimeout(playVideoCarousel, 500);
    }

    //info-block accordion begin
    $('.info-block .top').click(function () {
        if ($(window).width() <= 768 - sw) {
            $(this).parent().children('.info-block-description').stop().slideToggle(200);
    ...
    //info-block accordion end
    //drag menu in mobile begin
    maxMenuWidth = 0;
    $('header nav a').each(function () {
        var menuWidth = $(this).outerWidth();
        maxMenuWidth = maxMenuWidth + menuWidth;
    });
    //drag menu in mobile end
    //sliders begin
    if ($.isFunction('owlCarousel')) {
        $('.main-articles-inner').owlCarousel({
            loop: true,
            margin: 30,
            nav: true,
            items: 1,
            ...
            onTranslate: function onTranslate() {
                if ($(window).width() > 768 - sw) {
                    var STO = function STO() {
                        $('.main-articles .owl-item.active article video')[0].play();
                    };

                    $('.main-articles .owl-item.active article video')[0].pause();
        ...
        $('.begin-job.slider .items').owlCarousel({
            loop: true,
            margin: 10,
            nav: true,
            responsive: {
    ...
    function lines() {
        linesWrapLeft = 40;
        for (var i = 1; i <= 7; i++) {
            $('.bg-lines').append('<div class="lines-wrap"></div>');
            $('.lines-wrap:nth-child(' + i + ')').css({ 'left': linesWrapLeft + 'px' });
            linesWrapLeft = linesWrapLeft + 320;
        }
        for (var i2 = 1; i2 <= 3; i2++) {
            $('.lines-wrap').append('<div class="line"></div>');
        }
        $('.bg-lines .line').each(function () {
            var rand = 0 + Math.random() * (10 + 1 - 0);
            rand = Math.floor(rand);

            $(this).css({ 'top': rand * 20 + 'px' });
            $(this).attr('top', rand * 20);

            rand2 = 2 + Math.random() * (7 + 1 - 2);
            rand2 = Math.floor(rand2);
            $(this).attr('speed', rand2 * 20);
        });
        $('.lines-wrap').each(function () {
            var rand15 = 0 + Math.random() * (70 + 1 - 0);
            rand15 = Math.floor(rand15);

            $(this).css({ 'top': rand15 + '%' });
            $(this).attr('top', rand15);
        });
        $('header .lines-wrap').each(function () {
            var rand15 = 0 + Math.random() * (45 + 1 - 0);
            rand15 = Math.floor(rand15);

            $(this).css({ 'top': rand15 + '%' });
            $(this).attr('top', rand15);
        });
        $('footer .bg-lines .line').each(function () {
            var rand = 0 + Math.random() * (40 + 1 - 0);
            rand = Math.floor(rand);
        ...
        $('footer .lines-wrap').each(function () {
            var rand15 = 0 + Math.random() * (60 + 1 - 20);
            rand15 = Math.floor(rand15);
    ...
    if (window.location.pathname !== '/login' && window.location.pathname !== '/registration' && window.location.pathname !== '/forgot') {
        lines();
    }
    //lines end
    $(window).scroll(function () {
        ...
        if (ww > 768 - sw) {
            ...
            $('.bg-lines .line').each(function () {
                ...
                i++;
                var lineMt = $(this).attr('top') / 1;
                var spped = $(this).attr('speed') / 1;
                resScroll = -((wScroll - t) * spped / 30 / 20) + lineMt;
                if (t - wh > wScroll) {
                    $(this).css({ 'top': lineMt + 'px' });
                    // return false
                } else {
                    $(this).css({ 'top': resScroll + 'px' });
                }
            });
        }
    });
    if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
        $("header nav").wrapInner(function () {
            return "<div class='nav-inner'></div>";
        });
        $("header nav").addClass('mobile');
        $("footer nav").eq(0).wrapInner(function () {
            return "<div class='nav-inner'></div>";
        });
        $("footer nav").eq(0).addClass('mobile');
    } else {
        $("body header nav").draggable({
            axis: "x",
            cursor: "move",
            drag: function drag(event, ui) {
                var leftPosition = ui.position.left;
                var ww = $(window).width();
                if (ww >= $(this).width() + 100) {
                    return false;
                } else {
                    if (leftPosition <= ww - 560) {
                        return false;
                    }
                    if (leftPosition > 0) {
                        return false;
    ...
    function adaptive() {
        ...
        var owlSOW = $('.main-articles-inner .owl-stage-outer').width();
        leftpos = (ww - owlSOW) / 2;
        $('.main-articles-inner .owl-nav .owl-prev').css({
            'left': -leftpos + 'px',
            'width': leftpos + owlNavWidth + 'px'
        });
        $('.main-articles-inner .owl-nav .owl-next').css({
            'right': -leftpos + 'px',
            'width': leftpos + owlNavWidth + 'px'
        });
        // $('header nav > ul > li > ul').each(function(event){
    ...
    // открыть страницу раскрытие информации
    $('#open-info').click().css("display", "block");

    function checkValidateSubscribe() {
    ...
    $('#subscribe_form').submit(function (e) {
        checkValidateSubscribe();
        e.preventDefault();
        var errorsNumber = $(this).find('input.error').length;
        if (errorsNumber == 0) {
            var name = $('#subscribe_form #name').val();
            var email = $('#subscribe_form #email').val();
            $.ajax({
                type: 'post',
                url: 'NewSubscribe/IndexPopup',
                dataType: 'json',
                data: {
                    'email': email
                },
                success: function success(data) {
                    $('.subscribe_block_info').hide();
                    if (data.status == 1) {
                        $('.subscribe_block_info span.success').text('Вы подписались на рассылку!');
                        $('.subscribe_block_info span.error').text('');
                        $('.subscribe_block_body').fadeOut(350, function () {
                            $('.subscribe_block_info').show();
                        });
                    } else if (data.status == 0) {
                        if (data.error.email) {
                            $('.subscribe_block_info span.success').text('');
                            $('.subscribe_block_info span.error').text('Email введен не правильно или уже используется');
                        }
                        $('.subscribe_block_info').show();
                    }
                },
    ...
    // фокус сразу на поиск
    $("#top-button-search").click(function () {
        $("#search-input-term").focus();
    });

    // определяю айпад и удаляю на нем меню
    if (navigator.userAgent.match(/iPad/i) !== null) {
        $('.wrapper-nav').css('display', 'none');
    }
});

if (window.location.href.indexOf("Ticker") !== -1 && window.location.pathname === '/stocks/stock' || window.location.pathname === '/stocks/buy' || window.location.pathname === '/' || window.location.pathname === '/investIdeas/investIdea') {
    var updateStockModal = function updateStockModal(price) {
        $('.slider-item-inner').html(' ₽ ');
        $('.slider-item-tip').attr({ 'max': currentStock.MaxSize });
        $('.slider-item-max').html(currentStock.MaxSize);
        $('.popup-pic-item').html('<img src="/images/stocks/' + currentStock.Ticker + '.png" alt="">');
        $('.popup-title').html(currentStock.ShortName + ' <sup>' + currentStock.Ticker + '</sup>');
        $('.dd-state').html(currentStock.LotSize);
        $('.banner-logo').html('<img src="/images/stocks/' + currentStock.Ticker + '.png" alt="">');
        $('.title-text').html('Покупка инструмента ' + currentStock.ShortName);

        var $itemResult = $('.slider-item-result');
        var resultPrice = price.RubPrice * valueSelected * currentStock.LotSize;
        $itemResult.html(resultPrice.toFixed(2).replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,"));

        $('#sources-select').on('change', function (e) {
    ...
    var CreateOrder = function CreateOrder() {
        ...
        return $.ajax({
            url: '/proxyApi/createOrder',
            type: 'POST',
            data: params,
            dataType: 'json',
            success: function success(responce) {
                if (responce.Code === 1) {
                    $infoMessage.addClass('errorMessages').show().html(responce.Description + ', проверьте правильность введенных данных');
                } else if (responce.Code === 0) {
                    $infoMessage.addClass('successMessages').show().html('На указанный номер был отправлен код подтверждения');
                }
                clientOrder = responce.Result;
                console.log('success', clientOrder);
                return true;
            },
    ...
    var ConfirmOrder = function ConfirmOrder(elems) {
        var params = { Id: clientOrder.Id, Code: buyStockForm.elements["confirmPhone"].value };
        return $.ajax({
            url: '/proxyApi/confirmOrder',
            type: 'POST',
            data: params,
            dataType: 'json',
            success: function success(responce) {
                var confirmOrderItems = responce.Result;
                if (responce.Code === 1) {
                    event.preventDefault();
                    $infoMessage.addClass('errorMessages').show().html(responce.Description + ', проверьте правильность введенных данных');
                } else if (responce.Code === 0 && responce.Description === 'OK') {
                    var include = function include(array, callback) {
                    ...
                    // $('input[name="cost"]').val(confirmOrderItems.AmountWithTax); // сумма, которую клиент должен заплатить, может быть с учетом или без учета комиссии
                    // $('input[name="phone_number"]').val(confirmOrderItems.Phone); //телефонный номер плательщика
                    // $('input[name="default_email"]').val(confirmOrderItems.Email); //электронная почта клиента
                    // $('input[name="name"]').val('Покупка ' + confirmOrderItems.ShortName); //НАЗВАНИЕ что делаем
                    // $('input[name="order_id"]').val(confirmOrderItems.Id); //Обязательное поле. Не может содержать пробельные символы. Номер заказа в системе партнера, должен быть уникальным. Дважды заказ с одинаковым order_id оплатить не удастся. Если нет необходимости определять каждый заказ, то значение order_id нужно сделать равным 0. Для рекуррентных платежей длина >=6 символов

                    var url = 'https://partner.rficb.ru/alba/input/?sources=7&LastName=' + confirmOrderItems.LastName + '&FirstName=' + confirmOrderItems.FirstName + '&MiddleName=' + confirmOrderItems.MiddleName + '&Email=' + confirmOrderItems.Email + '&confirmPhone=' + confirmOrderItems.confirmPhone + '&checkbox=checkbox2&checkbox=checkbox3&key=PbUlmYy2DzrYPDR7HFVpUDSloZRTYa2JUAE1ay4rU34=&cost=' + confirmOrderItems.AmountWithTax + '&name=Покупка' + confirmOrderItems.ShortName + '&default_email=' + confirmOrderItems.Email + '&phone_number=' + confirmOrderItems.Phone + '&verbose=1&order_id=' + confirmOrderItems.Id + '';
                    ...
                    if (getCookie("utm")) {
                        ...
                        try {
                            if (JSON.parse(getCookie("utm")).actionpay && JSON.parse(getCookie("utm")).campaign === 'actionpay') {
                                var apypxlElement = '<img src="https://apypp.com/ok/16567.png?actionpay=' + JSON.parse(getCookie("utm")).actionpay + '&apid=' + roistatId + '" width="1px" height="1px"/>';
            ...
            error: function error(responce) {
                $infoMessage.addClass('errorMessages').show().html('Проверьте правильность введенных данных');
                event.preventDefault();
                if (responce.status === 400) {
                    console.log('status error', responce.status);
                }
            }
        });
    };
    ...
    var getStocks = function getStocks(param, sector) {
        $.ajax({
            url: '/proxyApi/getStocks2',
            type: 'POST',
            data: {
                Country: param ? param : 'all',
                Sector: sector ? sector : 'all',
                Tickers: [ticker]
            },
            dataType: 'json',
            success: function success(stocksResponce) {
                var stocks = stocksResponce.Result;
                stocks.forEach(function (stock) {
                    priceIds = stock.Id;
                    if (window.location.pathname === '/stocks/buy') {
                        initDropdownList('sources-select', 1, stock.MaxSize, stock.LotSize);
                    }
                    if (ticker === stock.Ticker) {
                        var currentTicker = stock.Ticker;
                        var currentName = stock.Name;

                        $(function () {
                            var url = '/themes/zericheu/images/stock/bg-mainphotos/' + currentTicker + '.jpg';
                            $.ajax(url, {
                                statusCode: {
                                    200: function _() {
                                        $('.header').addClass('stock-item-header');
                                        var bgColor = $('.stock-item-header').css("background-color", stock.Color);
                                        var urlImage = 'url("/themes/zericheu/images/stock/bg-mainphotos/' + currentTicker + '.jpg")';
                                        var bgImage = $('.stock-item-header').css("background-image", urlImage) ? bgImage : bgColor;
                                        $('meta[property="og:image"]').attr('content', '/themes/zericheu/images/stock/bg-mainphotos/' + currentTicker + '.jpg');
                                    }
                                }
                            });
                        });

                        if (window.location.pathname === '/stocks/stock' || window.location.pathname === '/stocks/buy') {
                            $('.nav-last').html(currentName);
                            var companyTitle = $('.company-item-title');
                            companyTitle.html('<h1>Покупка инструмента ' + currentName + '</h1>');
                            if (stock.Type === 'ETF') {
                                companyTitle.html('<h1>Покупка ' + currentName + '</h1>');
                            }
                        }

                        var logo = '<img src="/images/stocks/' + currentTicker + '.png" alt="' + stock.Name + '"></div>';
                        var logo2 = '<img src="/images/stocks/' + currentTicker + '2.png" alt="' + stock.Name + '"></div>';
                        var logoImage = logo ? logo : logo2;
                        $('.company-item-pic').html(logoImage);
                        $('.assets').html(stock.NetIncome);
                        $('.capital').html(stock.Capitalization);
                        $('.operating-profit').html(stock.OperatingIncome);

                        $('.slide:nth-of-type(1)').css("background-image", 'url(/themes/zericheu/images/stock/companyPhotos/' + currentTicker + '1.jpg)');
                        $('.slide:nth-of-type(2)').css("background-image", 'url(/themes/zericheu/images/stock/companyPhotos/' + currentTicker + '2.jpg)');
                        $('.slide:nth-of-type(3)').css("background-image", 'url(/themes/zericheu/images/stock/companyPhotos/' + currentTicker + '3.jpg)');

                        currentStock = stock;
                        var params = stock.Id;

                        GetStockRecommendations(params);
                        if (window.location.pathname === '/stocks/stock') {
                            GetStockPriceHistory(params);
                        }
                        if (window.location.pathname === '/investIdeas/investIdea') {
                            GetStockPriceHistoryIdeas(params);
                        }
                    }
                });
                getStockPrice();
                getTopStocks(['SBER', 'GAZP', 'LKOH', 'GMKN']); // получаем топ 4 акции
            }
        });
    };

    var GetStockRecommendations = function GetStockRecommendations(params) {
        $.ajax({
            url: '/proxyApi/getStockRecommendations',
            type: 'POST',
            data: { id: params },
            dataType: 'json',
            success: function success(recommendations) {
                recommendationsStock = recommendations.Result;
                recommendationsStock.forEach(function (recommendation) {
                    var date = recommendation.Date;
                    var formatDate = moment(date).format('DD.MM.YYYY');
                    var templateRec = [];
                    templateRec += '<div class="row-wrapper">';
                    templateRec += '<div class="cell" data-title="Источник">' + recommendation.FirmName + '</div>';
                    templateRec += '<div class="cell" data-title="Рекомендация">' + recommendation.Recommendation + '</div>';
                    templateRec += '<div class="cell" data-title="Целевая цена">' + recommendation.FormattedTargetPrice + '</div>';
                    templateRec += '<div class="cell" data-title="Дата рекомендации">' + formatDate + '</div>';
                    templateRec += '</div>';
                    var currentContainer = $('.table-item-row');
                    currentContainer.append(templateRec);
                });
            }
        });
    };
    ...
    var GetStockPriceHistory = function GetStockPriceHistory(params) {
        $.ajax({
            url: '/proxyApi/getStockPriceHistory',
            type: 'POST',
            data: { id: params },
            dataType: 'json',
            success: function success(history) {
                historyStock = history.Result;

                var labels = historyStock.map(function (e) {
                    moment.locale('ru');
                    return moment(e.Time).format('ll');
                });

                var dataPrice = historyStock.map(function (e) {
                    return e.Price;
                });

                // chart
                var chart = document.getElementById('chart').getContext('2d'),
                    gradient = chart.createLinearGradient(255, 255, 255, 0.10);

                gradient.addColorStop(0, 'rgba(255,255,255, 0.20)');
                gradient.addColorStop(0.5, 'rgba(255,255,255, 0.60)');
    ...
    var GetStockPriceHistoryIdeas = function GetStockPriceHistoryIdeas(params) {
        $.ajax({
            url: '/proxyApi/getStockPriceHistory',
            type: 'POST',
            data: { id: params },
            ...
            success: function success(history) {
                ...
                // chart
                var chart = document.getElementById('chart').getContext('2d'),
                    gradient = chart.createLinearGradient(209, 212, 216, 0.10);
    ...
    var getTopStocks = function getTopStocks(tickers) {
        $.ajax({
            url: '/proxyApi/getStocks2',
            type: 'POST',
            data: {
            ...
            dataType: 'json',
            success: function success(stocks) {
                var topStocks = stocks.Result;
                $.ajax({
                    url: '/proxyApi/getStockPrice',
                    type: 'POST',
                    dataType: 'json',
                    success: function success(topStocksPrice) {
                        getStockPrice();
                        topStocks.forEach(function (topStock) {
                            var tmp = [];

                            tmp += '<div class="share">\n' + '                    <div class="share-icon">\n' + '                        <img src="/images/stocks/' + topStock.Ticker + '.png" alt="акции ' + topStock.Ticker + '">\n' + '                    </div>\n' + '                    <div class="share-title">' + topStock.ShortName + '</div>\n' + '                    <div class="share-info">\n' + '                        <div class="share-property">Потенциал роста:</div>\n' + '                        <div class="shareId' + topStock.Id + ' share-value green green' + topStock.Id + '"></div>\n' + '                        <div class="clearfix"></div>\n' + '                        <div class="share-property">За акцию:</div>\n' + '                        <div class="shareId' + topStock.Id + ' share-value ruPrice' + topStock.Id + '"></div>\n' + '                        <div class="clearfix"></div>\n' + '                        <div class="share-property">Дивиденд:</div>\n' + '                        <div class="shareId' + topStock.Id + ' share-value ruDividend' + topStock.Id + '"></div>\n' + '                        <div class="clearfix"></div>\n' + '                    </div>\n' + '                    <a href="/stocks/stock?Ticker=' + topStock.Ticker + '.html" class="btn">Купить</a>\n' + '                </div>';
                            $('.owl-stage-tmp').append(tmp);
                        });

                        var topStocksPrices = topStocksPrice.Result;
                        topStocksPrices.forEach(function (topStockPrice) {
                            if (topStockPrice.Id === 33 || topStockPrice.Id === 32 || topStockPrice.Id === 31 || topStockPrice.Id === 68) {
                                var FormattedRubPrice = topStockPrice.FormattedRubPrice; //цена
                                var FormattedPercentDividendIncome = topStockPrice.FormattedPercentDividendIncome; // дивиденд
                                var FormattedPercentPlannedIncome = topStockPrice.FormattedPercentPlannedIncome; // потенциал роста

                                $('.green' + topStockPrice.Id).html(FormattedPercentPlannedIncome);
                                $('.ruPrice' + topStockPrice.Id).html(FormattedRubPrice);
                                $('.ruDividend' + topStockPrice.Id).html(FormattedPercentDividendIncome);
                            }
                        });
                    }
                });
    ...
    var getStockPrice = function getStockPrice() {
        $.ajax({
            ...
            dataType: 'json',
            success: function success(stocksPriceResponce) {
                stocksPrice = stocksPriceResponce.Result;
                stocksPrice.forEach(function (price) {
                    updateStockModal(price);

                    $('.popup-sum-item').html(price.FormattedRubPrice);
                    $('.potential').text(price.FormattedPercentPlannedIncome);
                    $('.divIncome').html(price.FormattedPercentDividendIncome);

                    if (price.FormattedPrice === null) {
                        $('.price').html(preloader);
                    } else {
                        $('.price').html(price.FormattedPrice);
                    }
                    if (price.PercentChange === null) {
                        $('.changesDay').html(preloader);
                    } else {
                        if (price.FormattedPercentChange.replace(/(?!-)[^0-9.]/g, '') > 0) {
                            $('.changesDay').html(price.FormattedPercentChange).css('color', '#22A053');
                        } else if (price.FormattedPercentChange.replace(/(?!-)[^0-9.]/g, '') < 0) {
                            $('.changesDay').html(price.FormattedPercentChange).css('color', '#DC5151');
                        }
                    }
                    if (price.Price === null) {
                        $('.btn-buy').hide();
    ...
    var getStockDescription = function getStockDescription() {
        $.ajax({
            url: '/stocks/filter?search=' + ticker,
            type: 'POST',
            dataType: 'json',
            success: function success(responce) {
                responce.forEach(function (value) {
                    if (value.ticker === ticker) {
                        $('.slide-footer-desc').html('<a class="redirect-url-value" target="_blank" rel="nofollow" href="' + value.redirect_url + '">Сайт для инвесторов</a>');
                    }
                });
            }
        });
    ...
    var initDropdownList = function initDropdownList(id, min, max, lotsize) {
        var select, i, option;
        select = document.getElementById(id);
        for (i = min; i <= max; i += 1) {
            option = document.createElement('option');
            option.value = i;
            option.text = i * lotsize;
            select.add(option);
        }
    };
    ...
    var $infoMessage = $('#infoMessage').hide();

    var checkValidateForm = function checkValidateForm(form) {
        var elems = form.elements;
        if (elems.LastName.value && elems.FirstName.value && elems.MiddleName.value && elems.Email.value && elems.Phone.value && elems.confirmPhone.value) {
            ConfirmOrder(elems);
            if (e) {
                e.preventDefault();
            }
    ...
    if (window.location.href.indexOf("Ticker") !== -1) {
        var ticker = gup('?', $(location).attr('href')).slice(0, -5);
    }

    $("#btn-buy-stock").attr('href', '/registration');
    $(".header-btn-top").attr('href', '/registration');

    var recommendationsStock = {};
    ...
    $(document).scroll(function () {
        if ($(this).scrollTop() > 600) {
            $('.head-nav-sticky').addClass('header-small').css('display', 'flex');
        } else if ($(this).scrollTop() < 600) {
            $('.head-nav-sticky').removeClass('header-small').css('display', 'none');
        }
    });
